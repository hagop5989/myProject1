...
<div class="wrap1">
    ...
    <form:form action="/board/update" method="post" modelAttribute="board">
        <tbody>
            <tr>
                <td><form:input path="boardId" value="${board.boardId}" readonly="true"/></td>
                <td><form:input path="title" value="${board.title}"/></td>
                <td><form:input path="writer" value="${board.writer}" readonly="true"/></td>
                <td><form:input path="inserted" value="${board.inserted}" readonly="true"/></td>
            </tr>
        </tbody>
    </table>
                <hr>
